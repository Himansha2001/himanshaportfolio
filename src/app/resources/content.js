...
const social = [
  ...
  // Import new icons in /once-ui/icons.ts
  {
    name: "GitHub",
    icon: "github",
    link: "https://github.com/Himansha2001",
  },
  {
    name: "LinkedIn",
    icon: "linkedin",
    link: "https://www.linkedin.com/in/himansha-thunmuduna/",
  },
  {
    name: "X",
    icon: "x",
  ...
  },
  {
    name: "Email",
    icon: "email",
    link: "mailto:himanshahishan@gmail.com",
  },
];
...
const home = {
  ...
  subline: (
    <>
      I'm Himansha, Software Engineer <InlineCode>undergraduate</InlineCode>, where I craft intuitive
      <br /> user experiences.
    </>
  ),
};
...
const about = {
  ...
  intro: {
    ...
    description: (
      <>
        I’m an undergraduate software engineer, freelancer, and entrepreneur with a passion for building scalable web and mobile applications.
    ...
    skills: [
      {
        ...
        description: <>JavaScript, C#, ASP.NET Core, Python, Dart, Node.js, React.js,HTML/CSS,Flutter,Express.js</>,
        // optional: leave the array empty if you don't want to display images
        images: [
          {
      ...
      },
      {
        ...
        description: <>Firebase, MongoDB, PostgreSQL, WebSockets, ASP.NET Core, REST APIs</>,
        // optional: leave the array empty if you don't want to display images
        images: [
          // {
      ...
      
      {
        ...
        description: <>MySQL, Firebase Database, MongoDB</>,
        // optional: leave the array empty if you don't want to display images
        images: [
          // {
          //   src: "/images/projects/project-01/cover-04.jpg",
